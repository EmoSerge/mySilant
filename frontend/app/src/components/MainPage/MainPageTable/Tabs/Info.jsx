                        ...
                        {machineArray.length <= 0 ? (
                            ...
                            machineArray.map((value, idx) => (
                                <tr key={value.factoryNumberOfMachine}>
                                    ...
                                    <td>
                                        <Link
                                            href={`mainbridge/${value.modelOfMainBridge.id}`}
                                        >
                                            {value.modelOfMainBridge.title}
                                        </Link>
                                    </td>
                                    <td>{value.factoryNumberOfMainBridge}</td>
                                    <td>
                                        <Link
                                            href={`steerablebridge/${value.modelOfSteerableBridge.id}`}
                                        >
                                            {value.modelOfSteerableBridge.title}
                                        </Link>
                                    </td>
                                    <td>{value.factoryNumberOfSteerableBridge}</td>
